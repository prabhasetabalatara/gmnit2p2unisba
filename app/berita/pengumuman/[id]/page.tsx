...
export default function PengumumanDetailPage() {
  ...
  const [relatedAnnouncements, setRelatedAnnouncements] = useState<Pengumuman[]>([]);
  ...
  useEffect(() => {
    const fetchPengumuman = async () => {
      ...
      if (!id) {
        router.push('/berita/pengumuman');
        return;
      }

      // Fetch current pengumuman
      ...
      // Parse images
      if (pengumumanData) {
        const parsedImages = parseLinks(pengumumanData.link);
        setImages(parsedImages);
      }

      // Fetch related announcements (excluding current)
      ...
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 font-medium">Memuat pengumuman...</p>
          </div>
        </div>
        <Footer />
      </>
      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-semibold text-gray-900 mb-2">Pengumuman tidak ditemukan</h1>
            <p className="text-gray-600 mb-8">Pengumuman yang Anda cari mungkin telah dihapus atau tidak tersedia.</p>
            <Link 
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <Link href="/berita/pengumuman" className="text-gray-500 hover:text-red-500 transition-colors">
              Pengumuman
            </Link>
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gray-100">
                ...
                >
                  <Image
                    ...
                    alt={`${pengumuman.judul} - Gambar ${currentImageIndex + 1}`}
                    fill
              ...
              >
                <div className="relative max-w-full max-h-full">
                  <Image
                    ...
                    alt={`${pengumuman.judul} - Gambar ${lightboxImageIndex + 1}`}
                    width={1200}
                    height={800}
          ...
          <footer className="mt-12 pt-8 border-t border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <div className="text-gray-500 text-sm">
                Dipublikasikan {new Date(pengumuman.tanggal).toLocaleDateString("id-ID", {
                  weekday: "long",
                  day: "numeric", 
                  month: "long",
                  year: "numeric",
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-light text-gray-900 mb-4">Pengumuman Terkait</h2>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3 leading-tight group-hover:text-red-600 transition-colors duration-300">
                        <Link href={`/berita/pengumuman/${related.id}`} className="hover:underline">
                      ...
                      <Link 
                        href={`/berita/pengumuman/${related.id}`}
