      ...
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 font-medium">Memuat berita terbaru...</p>
          </div>
        </div>
        <Footer />
      </>
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            <h1 className="text-6xl md:text-7xl font-light tracking-tight mb-6">
              Berita & <span className="text-red-500 font-medium">Informasi</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Tetap terhubung dengan informasi terkini dan perkembangan terbaru
            </p>
          </div>
        </div>
      </section>
      ...
      {featuredNews && (
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-light text-gray-900 mb-4">Berita Utama</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    {truncateText(featuredNews.isi, 200)}
                  </p>
                  <div className="flex items-center text-gray-500 text-sm">
                    <span>
                      {new Date(featuredNews.tanggal).toLocaleDateString("id-ID", {
                        day: "numeric",
                        month: "long",
                        year: "numeric",
                      })}
                  ...
                  <Link 
                    href={`/berita/berita/${featuredNews.id}`}
              ...
              <div className="order-1 lg:order-2">
                {(() => {
                  const linkArray = parseLinks(featuredNews.link);
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4">Berita Lainnya</h2>
            <div className="w-16 h-1 bg-red-500 mx-auto"></div>
          </div>

          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
            {berita.slice(1).map((b) => {
              const linkArray = parseLinks(b.link);
              const firstImage = linkArray[0];
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-4 leading-tight group-hover:text-red-600 transition-colors duration-300">
                      <Link href={`/berita/berita/${b.id}`} className="hover:underline">
                        {b.judul}
                      </Link>
                    </h3>
                    
                    <p className="text-gray-600 leading-relaxed mb-6">
                      {truncateText(b.isi, 120)}
                    </p>
          ...
          {berita.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-light text-gray-600 mb-2">Belum ada berita</h3>
